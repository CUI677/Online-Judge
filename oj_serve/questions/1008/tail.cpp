...
int main()
{
    Test(vector<int>{1, 2, 3, 4}, vector<int>{1, 4, 2, 3}, "Test1");
    Test(vector<int>{1, 2, 3, 4, 5}, vector<int>{1, 5, 2, 4, 3}, "Test2");
    Test(vector<int>{1, 2}, vector<int>{1, 2}, "Test3");
    Test(vector<int>{1}, vector<int>{1}, "Test4");
    return 0;
}
